...
#else
  #define PID_ROLL_RATE_KP  1.0
  #define PID_ROLL_RATE_KI  0.0
  #define PID_ROLL_RATE_KD  0.0
  #define PID_ROLL_RATE_INTEGRATION_LIMIT    1

  #define PID_PITCH_RATE_KP  1.0
  #define PID_PITCH_RATE_KI  0.0
  #define PID_PITCH_RATE_KD  0.0
  #define PID_PITCH_RATE_INTEGRATION_LIMIT   1

  #define PID_YAW_RATE_KP  1.0
  #define PID_YAW_RATE_KI  0.0
  #define PID_YAW_RATE_KD  0.0
  #define PID_YAW_RATE_INTEGRATION_LIMIT     1

  #define PID_ROLL_KP  1.0
  #define PID_ROLL_KI  0.0
  #define PID_ROLL_KD  0.0
  #define PID_ROLL_INTEGRATION_LIMIT    1.0

  #define PID_PITCH_KP  1.0
  #define PID_PITCH_KI  0.0
  #define PID_PITCH_KD  0.0
  #define PID_PITCH_INTEGRATION_LIMIT   1.0

  #define PID_YAW_KP  1.0
  #define PID_YAW_KI  0.0
  #define PID_YAW_KD  0.0
  #define PID_YAW_INTEGRATION_LIMIT     1.0


  #define DEFAULT_PID_INTEGRATION_LIMIT 1.0
  #define DEFAULT_PID_OUTPUT_LIMIT      0.0
#endif 
